...
df_news=pd.read_csv(DATA_PATH.joinpath("csv/news.csv"), low_memory=False, encoding="euc-kr")
                ...
                html.Div(
                    [
                        dbc.ListGroup([
                            ...
                            dbc.ListGroupItem(
                                df_news.iloc[0, 0],
                                href=df_news.iloc[0, 1],     
                                className="row pretty_container columns",
                            ),
                            dbc.ListGroupItem(
                                df_news.iloc[1, 0],
                                href=df_news.iloc[1, 1],     
                                className="row pretty_container columns",
                            ),
                            dbc.ListGroupItem(
                                df_news.iloc[2, 0],
                                href=df_news.iloc[2, 1],     
                                className="row pretty_container columns",
                            ),
                            dbc.ListGroupItem(
                                df_news.iloc[3, 0],
                                href=df_news.iloc[3, 1],     
                                className="row pretty_container columns",
                            ),
                            dbc.ListGroupItem(
                                df_news.iloc[4, 0],
                                href=df_news.iloc[4, 1],     
                                className="row pretty_container columns",
                            ),
                        ])
                    ], className="pretty_container five columns",
